...
<head>
  ...
  <style>
    ...
    .kpi-icon { width:38px; height:38px; border-radius:10px; background:#eef2e6; color:#2f3a18;
      ...
      <div class="row kpi-row">
        <c:forEach items="${listaRepartidores}" var="r">
          ...
          <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
            <a href="${urlVista}" class="kpi-card" draggable="false" aria-label="Ver notas de ${r.nombreRepartidor}">
              <div class="d-flex align-items-center mb-1">
                <div class="kpi-icon"><span><c:out value="${fn:substring(r.nombreRepartidor,0,1)}"/></span></div>
              ...
              <div class="d-flex gap-2 mt-2">
                <span class="badge badge-soft">
                  <i class="bi bi-receipt"></i>&nbsp;<c:out value="${cntNotas}"/> nota(s)
                </span>
                <span class="badge badge-soft">
                  <i class="bi bi-cash-coin"></i>&nbsp;<fmt:formatNumber value="${totHoy}" type="currency"/>
                </span>
              </div>
...
<!-- Toastr (fragmento reusable) -->
<jsp:include page="/WEB-INF/jspf/toastr.jspf"/>
