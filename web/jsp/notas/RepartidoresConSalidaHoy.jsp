    ...
    <c:otherwise>
      ...
      <div class="row kpi-row">
        <c:forEach items="${listaRepartidores}" var="r">
          ...
          <!-- Métricas si vienen del servlet -->
          ...
          <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
            <!-- draggable="false" + ondragstart="return false;" para bloquear por completo -->
            <a href="${urlVista}"
               class="kpi-card"
               draggable="false"
               ondragstart="return false;"
               aria-label="Ver notas de ${r.nombreRepartidor}">
...
<script>
  // Defensa extra: cancela cualquier intento de arrastrar elementos de la tarjeta
  document.addEventListener('dragstart', function (ev) {
    if (ev.target.closest && ev.target.closest('.kpi-card')) {
      ev.preventDefault();
    }
  }, {passive:false});
</script>
